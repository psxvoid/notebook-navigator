...
const RELEASE_NOTES: ReleaseNote[] = [
    {
        ...
        fixed: [
            ...
            '**Fixed empty folders losing their custom properties on restart**. The metadata cleanup now properly preserves settings for empty folders by traversing the entire folder tree instead of only checking folders containing markdown files.'
        ]
    },
    {
        version: '1.3.15',
