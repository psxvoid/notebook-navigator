...
export const STRINGS_ID = {
    ...
    navigationPane: {
        ...
        reorderRootFoldersTitle: 'Atur ulang bagian navigasi',
        reorderRootFoldersHint: 'Seret header atau item untuk mengubah urutan',
    ...
    commands: {
        ...
        paneJumpTop: 'Lompat ke atas daftar',
        paneJumpBottom: 'Lompat ke bagian bawah daftar',
        paneJumpParent: 'Lompat/ungkapkan file aktif di tag atau folder induk',
        paneJumpChildren: 'Lompat/ungkapkan file aktif di tag atau folder anak',
    },
    ...
    settings: {
        ...
        groups: {
            ...
            notes: {
                ...
                textTransformEmptyTitle: 'Pola harus berupa RegExp yang valid',
            }
        },
        items: {
            searchProvider: {
            ...
            collapseFileTagsToSelectedTag: {
                name: 'Ciutkan tag ke tag yang dipilih',
                desc: 'Sembunyikan segmen induk yang merupakan bagian dari tampilan tag yang dipilih.'
            },
            colorFileTags: {
            ...
            titleTransformName: {
                name: 'Judul berubah',
                desc: `Mengganti seluruh judul atau sebagiannya dengan nilai khusus. Misalnya, Anda dapat menggunakan ini untuk mengganti "idea" di awal judul catatan dengan ikon Unicode bola lampu. Menggunakan sintaks "string.replace". Cache perlu dibangun ulang untuk menerapkan perubahan pada catatan yang sudah ada.`
            },
            previewTransformName: {
                name: 'Pratinjau transformasi',
                desc: `Mengganti seluruh pratinjau atau sebagiannya dengan nilai khusus. Mungkin berguna jika catatan Anda berisi blok yang tidak ingin Anda lihat di daftar catatan. Menggunakan sintaks "string.replace". Memerlukan pembuatan ulang cache untuk menerapkan perubahan pada catatan yang ada.`
            },
            showFeatureImage: {
            ...
            featureImageSize: {
                name: 'Ukuran gambar unggulan',
                desc: 'Mengatur ukuran gambar unggulan yang akan digunakan dalam daftar catatan.'
            },
            featureImageForPDF: {
                name: 'Gambar unggulan untuk PDF',
                desc: 'Memungkinkan pembuatan gambar unggulan untuk PDF.'
            },
            featureImagePersistIntermediate: {
                name: 'Simpan gambar berfitur lengkap ke disk',
                desc: 'Hanya untuk pengguna tingkat lanjut. Mengaktifkan opsi ini akan menyimpan gambar-gambar antara yang berfitur lengkap ke dalam disk. Mungkin berguna untuk mempercepat pengindeksan awal saat mengubah ukuran dan sinkronisasi gambar-gambar unggulan. Memerlukan pembangunan ulang cache saat diaktifkan. Tidak membersihkan gambar-gambar antara setelah dinonaktifkan.'
            },
            showRootFolder: {
            ...
            rebuildCacheFast: {
                name: 'Segarkan cache',
                desc: `Gunakan ini jika Anda mengalami tag yang hilang, pratinjau yang salah, atau gambar fitur yang hilang. Hal ini dapat terjadi setelah konflik sinkronisasi atau penutupan yang tidak terduga. Versi yang jauh lebih ringan daripada "Rebuild Cache", tetapi mungkin tidak menyelesaikan semua masalah.`,
                buttonText: 'Segarkan cache',
                success: 'Cache diperbarui',
                error: 'Gagal menyegarkan cache'
            },
            rebuildCache: {
