...
export const STRINGS_PT = {
    ...
    commands: {
        ...
        paneJumpTop: 'Ir para o início da lista',
        paneJumpBottom: 'Ir para o fim da lista',
        paneJumpParent: 'Ir para o ficheiro ativo ou revelá-lo na etiqueta ou pasta pai',
        paneJumpChildren: 'Ir para o ficheiro ativo ou revelá-lo na tag ou pasta filha',
    },
    ...
    settings: {
        ...
        groups: {
            ...
            notes: {
                ...
                textTransformEmptyTitle: 'Um padrão deve ser uma expressão regular válida',
            }
        },
        items: {
            searchProvider: {
                ...
                info: {
                    filterSearch: {
                        ...
                        description:
                            'Pesquisa rápida e leve que filtra ficheiros por nome e etiquetas na pasta atual e subpastas. Suporta filtragem de etiquetas com prefixo # (ex: #projeto), exclusão com prefixo ! (ex: !rascunho, !#arquivo), e encontrar notas sem etiquetas com !#. Ideal para navegação rápida no contexto atual.'
                    },
                    omnisearch: {
                        title: 'Omnisearch:',
                        description:
            ...
            parentFolderClickRevealsFile: {
                name: 'Clicar na pasta pai revela ficheiro',
                desc: 'Clicar na etiqueta da pasta pai revela o ficheiro.'
            },
            ...
            collapseFileTagsToSelectedTag: {
                name: 'Recolher etiquetas para uma etiqueta selecionada',
                desc: 'Ocultar segmentos pai que fazem parte de uma vista de etiqueta selecionada.'
            },
            colorFileTags: {
            ...
            titleTransformName: {
                name: 'Transformações de títulos',
                desc: `Substitui todo o título ou partes dele por um valor personalizado. Por exemplo, pode utilizar isto para substituir "ideia" no início do título de uma nota por um ícone Unicode de lâmpada. Utiliza a sintaxe "string.replace". Requer a reconstrução da cache para aplicar as alterações às notas existentes.`
            },
            previewTransformName: {
                name: 'Pré-visualização transforma',
                desc: `Substitui toda a pré-visualização ou partes da mesma por um valor personalizado. Pode ser útil se as suas notas contiverem blocos que não pretende ver na lista de notas. Utiliza a sintaxe "string.replace". Requer a reconstrução da cache para aplicar as alterações às notas existentes.`
            },
            showFeatureImage: {
            ...
            featureImageSize: {
                name: 'Tamanho da imagem em destaque',
                desc: 'Define o tamanho da imagem em destaque a utilizar na lista de notas.'
            },
            featureImageForPDF: {
                name: 'Imagens em destaque para PDF',
                desc: 'Permite gerar imagens em destaque para PDFs.'
            },
            featureImagePersistIntermediate: {
                name: 'Guardar imagem completa no disco',
                desc: 'Apenas para utilizadores avançados. Ativar esta opção guarda imagens intermédias completas em disco. Pode ser útil para acelerar a indexação inicial ao alterar o tamanho e a sincronização das imagens em destaque. Requer a reconstrução da cache ao ativar. Não remove as imagens intermédias após ser desativada.'
            },
            showRootFolder: {
            ...
            rebuildCacheFast: {
                ...
                desc: `Utilize esta opção se estiver a ter problemas como tags em falta, pré-visualizações incorretas ou imagens de recursos em falta. Isto pode ocorrer após conflitos de sincronização ou encerramentos inesperados. É uma versão muito mais leve do que "Recriar Cache", mas pode não resolver todos os problemas.`,
                buttonText: 'Atualizar cache',
                success: 'Cache atualizado',
                error: 'Falha ao atualizar a cache'
            },
            rebuildCache: {
