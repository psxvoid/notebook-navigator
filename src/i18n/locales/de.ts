...
export const STRINGS_DE = {
    ...
    settings: {
        ...
        items: {
            ...
            hotkeys: {
                infoText: 'Die Tastenkürzel von Notebook Navigator können durch Bearbeiten der data.json-Datei im Plugin-Ordner angepasst werden. So passen Sie Tastenkürzel an:\n\n1. Navigieren Sie zum Ordner .obsidian/plugins/notebook-navigator/ in Ihrem Vault\n2. Öffnen Sie data.json in einem Texteditor\n3. Suchen Sie den Abschnitt "keyboardShortcuts"\n4. Ändern Sie die Tastenkombinationen für jeden Befehl\n\nJeder Befehl folgt dieser JSON-Struktur:\n"pane:move-up": [\n  {\n    "key": "ArrowUp",\n    "modifiers": []\n  }\n]\n\nModifikatortasten (zum "modifiers"-Array hinzufügen):\n• "Mod": Cmd auf macOS, Strg auf Windows/Linux\n• "Alt": Alt/Option-Taste\n• "Shift": Umschalttaste\n• "Ctrl": Steuerungstaste ("Mod" für plattformübergreifende Kompatibilität verwenden)\n\nSie können mehrere Tasten demselben Befehl zuweisen, was nützlich ist, um VIM-ähnliche Navigation neben den Pfeiltasten hinzuzufügen. Zum Beispiel, um sowohl ArrowUp als auch K für die Aufwärtsbewegung zu verwenden:\n"pane:move-up": [\n  { "key": "ArrowUp", "modifiers": [] },\n  { "key": "K", "modifiers": [] }\n]\n\nHinweis: Tastatursequenzen (wie "gg" oder "dd" in VIM) werden derzeit nicht unterstützt. Jede Tastenkombination muss ein einzelner Tastendruck mit optionalen Modifikatoren sein.\n\nNach der Bearbeitung von data.json, laden Sie Obsidian neu oder deaktivieren/aktivieren Sie das Plugin, damit die Änderungen wirksam werden.'
            },
            externalIcons: {
