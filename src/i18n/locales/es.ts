...
export const STRINGS_ES = {
    ...
    settings: {
        ...
        items: {
            ...
            hotkeys: {
                infoText: 'Los atajos de teclado de Notebook Navigator se pueden personalizar editando el archivo data.json en la carpeta del plugin. Para personalizar los atajos:\n\n1. Navegue a la carpeta .obsidian/plugins/notebook-navigator/ de su bóveda\n2. Abra data.json en un editor de texto\n3. Busque la sección "keyboardShortcuts"\n4. Modifique las combinaciones de teclas para cada comando\n\nCada comando sigue esta estructura JSON:\n"pane:move-up": [\n  {\n    "key": "ArrowUp",\n    "modifiers": []\n  }\n]\n\nTeclas modificadoras (agregar al array "modifiers"):\n• "Mod": Cmd en macOS, Ctrl en Windows/Linux\n• "Alt": Tecla Alt/Opción\n• "Shift": Tecla Mayús\n• "Ctrl": Tecla Control (use "Mod" para compatibilidad multiplataforma)\n\nPuede asignar múltiples teclas al mismo comando, lo cual es útil para agregar navegación estilo VIM junto con las teclas de flecha. Por ejemplo, para usar tanto ArrowUp como K para moverse hacia arriba:\n"pane:move-up": [\n  { "key": "ArrowUp", "modifiers": [] },\n  { "key": "K", "modifiers": [] }\n]\n\nNota: Las secuencias de teclado (como "gg" o "dd" en VIM) no están soportadas actualmente. Cada atajo debe ser una sola pulsación de tecla con modificadores opcionales.\n\nDespués de editar data.json, recargue Obsidian o desactive/active el plugin para que los cambios surtan efecto.'
            },
            externalIcons: {
