    ...
    settings: {
        ...
        items: {
            ...
            frontmatterIconizeFormat: {
                ...
                desc: 'Guarda iconos usando el formato Iconize (ej. LiHome, FasUser, SiGithub) en lugar del formato del plugin (ej. lucide-home, fontawesome-solid:user, simple-icons:github).'
            },
