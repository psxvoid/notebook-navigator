...
export const STRINGS_FA = {
    ...
    commands: {
        ...
        paneJumpTop: 'پرش به بالای لیست',
        paneJumpBottom: 'پرش به پایین لیست',
        paneJumpParent: 'پرش/نمایش فایل فعال در تگ یا پوشه والد',
        paneJumpChildren: 'پرش/نمایش فایل فعال در تگ یا پوشه فرزند',
    },
    ...
    settings: {
        ...
        groups: {
            ...
            notes: {
                ...
                textTransformEmptyTitle: 'یک الگو باید یک عبارت منظم (RegExp) معتبر باشد',
            }
        },
        items: {
            searchProvider: {
            ...
            tagProps: {
                tagPropMode: {
                    name: 'حالت برچسب (پروفایل گاوصندوق)',
                    desc: 'حالت برچسبی که برای این پروفایل گاوصندوق استفاده می‌شود و در درخت برچسب نمایش داده می‌شود. "هیچکدام" به این معنی است که از برچسب‌های معمولی استفاده می‌شود. "جایگزین کردن" به این معنی است که فقط ویژگی‌های برچسب سفارشی قابل مشاهده هستند و برچسب‌های معمولی پنهان هستند. "Merge" به این معنی است که هم ویژگی‌های برچسب و هم برچسب‌های معمولی قابل مشاهده هستند.',
                    options: {
                        none: 'هیچکدام',
                ...
                mainTagProp: {
                    name: 'برچسب اصلی (پروفایل گاوصندوق)',
                    desc: 'اجازه می‌دهد مشخص کنید کدام برچسب یا ویژگی برچسب به عنوان برچسب‌های "اصلی" در نظر گرفته شود. برچسب‌های اصلی در عملیات ویرایش برچسب استفاده می‌شوند. "پیش‌فرض" به این معنی است که برچسب‌های معمولی به عنوان برچسب‌های اصلی تنظیم می‌شوند. "ویژگی برچسب اول" به این معنی است که اولین ویژگی برچسب در "لیست ویژگی‌های برچسب" به عنوان "اصلی" تنظیم می‌شود.',
                    options: {
                        default: 'پیش‌فرض',
                        firstTagProp: 'ویژگی برچسب اول',
                    }
                },
                tagPropList: {
                    name: 'ویژگی‌های برچسب (پروفایل گاوصندوق)',
                    desc: 'فهرستی از ویژگی‌های frontmatter که با کاما از هم جدا شده‌اند. ویژگی‌های فهرست‌شده به عنوان منابع اضافی برای برچسب‌ها (مثلاً base-tags، note-class-tags) در نظر گرفته می‌شوند.',
                    placeholder: 'تگ‌های پایه، تگ‌های سفارشی',
                },
            },
            ...
            collapseFileTagsToSelectedTag: {
                name: 'جمع کردن برچسب‌ها به یک برچسب انتخاب شده',
                desc: 'بخش‌های والد که بخشی از نمای برچسب انتخاب شده هستند را پنهان کنید.'
            },
            colorFileTags: {
            ...
            titleTransformName: {
                name: 'تبدیل عنوان',
                desc: `کل عنوان یا بخش‌هایی از آن را با یک مقدار سفارشی جایگزین می‌کند. برای مثال، می‌توانید از این برای جایگزینی "ایده" در ابتدای عنوان یادداشت با یک آیکون یونیکد لامپ استفاده کنید. از سینتکس "string.replace" استفاده می‌کند. برای اعمال تغییرات در یادداشت‌های موجود، نیاز به بازسازی حافظه پنهان (cache) است.`
            },
            previewTransformName: {
                name: 'پیش‌نمایش تبدیل‌ها',
                desc: `کل پیش‌نمایش یا بخش‌هایی از آن را با یک مقدار سفارشی جایگزین می‌کند. اگر یادداشت‌های شما حاوی بلوک‌هایی باشند که تمایلی به دیدن آنها در لیست یادداشت‌ها ندارید، ممکن است مفید باشد. از سینتکس "string.replace" استفاده می‌کند. برای اعمال تغییرات در یادداشت‌های موجود، نیاز به بازسازی حافظه پنهان (cache) است.`
            },
            showFeatureImage: {
            ...
            featureImageSize: {
                name: 'اندازه تصویر ویژه',
                desc: 'اندازه تصویر شاخص مورد استفاده در لیست یادداشت‌ها را تنظیم می‌کند.'
            },
            featureImageForPDF: {
                name: 'تصاویر ویژه برای PDF',
                desc: 'امکان ایجاد تصاویر شاخص برای فایل‌های PDF را فراهم می‌کند.'
            },
            featureImagePersistIntermediate: {
                name: 'تصویر کامل را روی دیسک ذخیره کنید',
                desc: 'فقط برای کاربران پیشرفته. فعال کردن این گزینه، تصاویر میانی با تمام ویژگی‌های برجسته را در دیسک ذخیره می‌کند. ممکن است برای سرعت بخشیدن به فهرست‌بندی اولیه هنگام تغییر اندازه تصاویر ویژه و همگام‌سازی مفید باشد. هنگام فعال کردن، نیاز به بازسازی حافظه پنهان دارد. تصاویر میانی را پس از غیرفعال کردن پاک نمی‌کند.'
            },
            showRootFolder: {
            ...
            rebuildCacheFast: {
                name: 'تازه کردن حافظه پنهان',
                desc: `اگر با مشکل از دست دادن برچسب‌ها، پیش‌نمایش‌های نادرست یا از دست دادن تصاویر ویژگی مواجه شدید، از این استفاده کنید. این اتفاق می‌تواند پس از تداخل همگام‌سازی یا بسته شدن‌های غیرمنتظره رخ دهد. نسخه بسیار سبک‌تر از "بازسازی حافظه پنهان" است، اما ممکن است همه مشکلات را برطرف نکند.`,
                buttonText: 'تازه کردن حافظه پنهان',
                success: 'حافظه پنهان (cache) به‌روزرسانی شد',
                error: 'به‌روزرسانی حافظه پنهان انجام نشد'
            },
            rebuildCache: {
                name: 'بازسازی کش',
