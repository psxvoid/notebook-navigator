...
export const STRINGS_FA = {
    ...
    modals: {
        ...
        colorPicker: {
            ...
            copyColors: 'کپی رنگ‌ها',
            colorsCopied: 'رنگ‌ها در کلیپ‌بورد کپی شد',
            copyClipboardError: 'نمی‌توان در کلیپ‌بورد نوشت',
            pasteColors: 'چسباندن رنگ‌ها',
            pasteClipboardError: 'نمی‌توان کلیپ‌بورد را خواند',
            pasteInvalidJson: 'کلیپ‌بورد حاوی JSON معتبر نیست',
            pasteInvalidFormat: 'آرایه‌ای از مقادیر رنگ مورد انتظار است',
            colorsPasted: 'رنگ‌ها با موفقیت چسبانده شد',
            resetUserColors: 'بازنشانی رنگ‌ها',
    ...
    settings: {
        ...
        items: {
            searchProvider: {
                ...
                info: {
                    filterSearch: {
                        ...
                        description:
                            'جستجوی سریع و سبک که فایل‌ها را بر اساس نام و برچسب در پوشه و زیرپوشه‌های فعلی فیلتر می‌کند. پشتیبانی از فیلتر برچسب با پیشوند # (مثل #پروژه)، حذف با پیشوند ! (مثل !پیش‌نویس، !#بایگانی)، و یافتن یادداشت‌های بدون برچسب با !#. ایده‌آل برای ناوبری سریع در متن فعلی.'
                    },
                    omnisearch: {
                        title: 'Omnisearch:',
                        description:
            ...
            parentFolderClickRevealsFile: {
                name: 'کلیک روی پوشه والد فایل را نمایش می‌دهد',
                desc: 'کلیک روی برچسب پوشه والد فایل را نمایش می‌دهد.'
            },
            ...
            showTags: {
                name: 'نمایش برچسب‌ها',
                desc: 'بخش برچسب‌ها را زیر پوشه‌ها در ناوبر نمایش دهید.'
            },
            showTagIcons: {
