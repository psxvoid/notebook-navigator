    ...
    settings: {
        ...
        items: {
            ...
            collapseFileTagsToSelectedTag: {
                ...
                desc: 'Verberg bovenliggende segmenten die deel uitmaken van een geselecteerde tagweergave.'
            },
            colorFileTags: {
            ...
            featureImageSize: {
                name: 'Grootte van de uitgelichte afbeelding',
                desc: 'Sets the size of the featured image to be used in the note list.'
            },
            featureImageForPDF: {
                name: 'Featured images for PDF',
                desc: "Hiermee kunt u uitgelichte afbeeldingen voor PDF's genereren."
            },
            featureImagePersistIntermediate: {
                name: 'Sla de afbeelding met de volledige functionaliteit op schijf op',
                desc: 'Alleen voor gevorderde gebruikers. Als u deze optie inschakelt, worden tussenliggende afbeeldingen met volledige functionaliteit op een schijf opgeslagen. Dit kan nuttig zijn om de eerste indexering te versnellen bij het wijzigen van de grootte van de afbeeldingen en bij synchronisatie. Vereist een heropbouw van de cache bij inschakeling. Tussenliggende afbeeldingen worden niet opgeschoond na uitschakeling.'
            },
            showRootFolder: {
                name: 'Hoofdmap tonen',
