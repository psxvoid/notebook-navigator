...
export const STRINGS_VI = {
    ...
    commands: {
        ...
        paneJumpTop: 'Nhảy đến đầu danh sách',
        paneJumpBottom: 'Nhảy đến cuối danh sách',
        paneJumpParent: 'Nhảy/hiển thị tệp đang hoạt động trong thẻ cha hoặc thư mục',
        paneJumpChildren: 'Nhảy/hiển thị tệp đang hoạt động trong thẻ con hoặc thư mục',
    },
    ...
    settings: {
        ...
        items: {
            ...
            collapseFileTagsToSelectedTag: {
                name: 'Thu gọn thẻ thành thẻ đã chọn',
                desc: 'Ẩn các phân đoạn cha là một phần của chế độ xem thẻ đã chọn.'
            },
            colorFileTags: {
                name: 'Tô màu thẻ tệp',
            ...
            titleTransformName: {
                name: 'Tiêu đề chuyển đổi',
                desc: `Thay thế toàn bộ tiêu đề hoặc một phần tiêu đề bằng một giá trị tùy chỉnh. Ví dụ: bạn có thể sử dụng tùy chọn này để thay thế "idea" ở đầu tiêu đề ghi chú bằng biểu tượng bóng đèn Unicode. Sử dụng cú pháp "string.replace". Cần xây dựng lại bộ nhớ đệm để áp dụng các thay đổi cho các ghi chú hiện có.`
            },
            previewTransformName: {
                name: 'Xem trước chuyển đổi',
                desc: `Thay thế toàn bộ bản xem trước hoặc một phần của nó bằng một giá trị tùy chỉnh. Có thể hữu ích nếu ghi chú của bạn chứa các khối mà bạn không muốn thấy trong danh sách ghi chú. Sử dụng cú pháp "string.replace". Cần xây dựng lại bộ nhớ đệm để áp dụng các thay đổi cho các ghi chú hiện có.`
            },
            showFeatureImage: {
            ...
            featureImageSize: {
                name: 'Kích thước hình ảnh nổi bật',
                desc: 'Đặt kích thước của hình ảnh nổi bật sẽ được sử dụng trong danh sách ghi chú.'
            },
            featureImageForPDF: {
                name: 'Hình ảnh nổi bật cho PDF',
                desc: 'Cho phép tạo hình ảnh nổi bật cho tệp PDF.'
            },
            featureImagePersistIntermediate: {
                name: 'Lưu hình ảnh đầy đủ tính năng vào đĩa',
                desc: 'Chỉ dành cho người dùng nâng cao. Bật tùy chọn này sẽ lưu ảnh đầy đủ tính năng trung gian vào đĩa. Có thể hữu ích để tăng tốc quá trình lập chỉ mục ban đầu khi thay đổi kích thước và đồng bộ hóa ảnh nổi bật. Cần tạo lại bộ nhớ đệm khi bật. Không dọn dẹp ảnh trung gian sau khi tắt.'
            },
            showRootFolder: {
            ...
            rebuildCacheFast: {
                name: 'Làm mới bộ nhớ đệm',
                desc: `Hãy sử dụng tùy chọn này nếu bạn gặp sự cố thiếu thẻ, xem trước không chính xác hoặc thiếu hình ảnh tính năng. Điều này có thể xảy ra sau khi đồng bộ hóa xung đột hoặc đóng đột ngột. Phiên bản nhẹ hơn nhiều so với "Xây dựng lại bộ nhớ đệm" nhưng có thể không khắc phục được tất cả các sự cố.`,
                buttonText: 'Làm mới bộ nhớ đệm',
                success: 'Đã làm mới bộ nhớ đệm',
                error: 'Không làm mới được bộ nhớ đệm'
            },
            rebuildCache: {
