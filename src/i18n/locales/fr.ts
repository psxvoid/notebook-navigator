    ...
    settings: {
        ...
        items: {
            ...
            frontmatterIconizeFormat: {
                ...
                desc: 'Enregistre les icônes au format Iconize (ex. LiHome, FasUser, SiGithub) au lieu du format du plugin (ex. lucide-home, fontawesome-solid:user, simple-icons:github).'
            },
