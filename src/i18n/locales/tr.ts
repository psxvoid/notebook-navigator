...
export const STRINGS_TR = {
    ...
    commands: {
        ...
        paneJumpTop: 'Listenin en üstüne atla',
        paneJumpBottom: 'Listenin en altına atla',
        paneJumpParent: 'Üst etiket veya klasördeki etkin dosyayı atla/göster',
        paneJumpChildren: 'Alt etiket veya klasördeki etkin dosyayı atla/göster',
    },
    ...
    settings: {
        ...
        items: {
            ...
            collapseFileTagsToSelectedTag: {
                name: 'Etiketleri seçili bir etikete daralt',
                desc: 'Seçili etiket görünümünün parçası olan üst segmentleri gizle.'
            },
            colorFileTags: {
            ...
            titleTransformName: {
                name: 'Başlık dönüşümleri',
                desc: `Başlığın tamamını veya bir kısmını özel bir değerle değiştirir. Örneğin, bir not başlığının başındaki "idea" ifadesini bir ampul unicode simgesiyle değiştirmek için bunu kullanabilirsiniz. "string.replace" sözdizimini kullanır. Değişiklikleri mevcut notlara uygulamak için önbelleğin yeniden oluşturulmasını gerektirir.`
            },
            previewTransformName: {
                name: 'Önizleme dönüşümleri',
                desc: `Önizlemenin tamamını veya bir kısmını özel bir değerle değiştirir. Notlarınız not listesinde görmek istemediğiniz bloklar içeriyorsa faydalı olabilir. "string.replace" sözdizimini kullanır. Mevcut notlara değişiklik uygulamak için önbelleğin yeniden oluşturulmasını gerektirir.`
            },
            showFeatureImage: {
            ...
            featureImageSize: {
                name: 'Öne çıkan görsel boyutu',
                desc: 'Not listesinde kullanılacak öne çıkan görselin boyutunu ayarlar.'
            },
            featureImageForPDF: {
                name: 'PDF için öne çıkan görseller',
                desc: `PDF'ler için öne çıkan görsellerin oluşturulmasına olanak tanır.`
            },
            featureImagePersistIntermediate: {
                name: 'Tam özellikli görseli diske kaydet',
                desc: 'Yalnızca ileri düzey kullanıcılar için. Bu seçeneği etkinleştirmek, ara özellikli tam özellikli görüntüleri bir diske kaydeder. Öne çıkan görüntülerin boyutunu ve senkronizasyonunu değiştirirken ilk dizinlemeyi hızlandırmak için yararlı olabilir. Etkinleştirildiğinde önbelleğin yeniden oluşturulmasını gerektirir. Devre dışı bırakıldıktan sonra ara özellikli görüntüleri temizlemez.'
            },
            showRootFolder: {
            ...
            rebuildCacheFast: {
                name: 'Önbelleği yenile',
                desc: `Eksik etiketler, hatalı önizlemeler veya eksik özellikli görseller yaşıyorsanız bunu kullanın. Bu durum, senkronizasyon çakışmaları veya beklenmedik kapanmalar sonrasında ortaya çıkabilir. "Önbelleği Yeniden Oluştur"dan çok daha hafif bir sürümdür, ancak tüm sorunları çözmeyebilir.`,
                buttonText: 'Önbelleği yenile',
                success: 'Önbellek yenilendi',
                error: 'Önbellek yenilenemedi'
            },
            rebuildCache: {
