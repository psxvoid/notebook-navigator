...
export const STRINGS_UK = {
    ...
    commands: {
        ...
        paneJumpTop: 'Перейти на початок списку',
        paneJumpBottom: 'Перейти до кінця списку',
        paneJumpParent: 'Перейти/показати активний файл у батьківському тезі або папці',
        paneJumpChildren: 'Перейти/показати активний файл у дочірньому тегу або папці',
    },
    ...
    settings: {
        ...
        groups: {
            ...
            notes: {
                ...
                textTransformAdd: 'Додати нове перетворення',
                textTransformPatternPlaceholder: 'Регулярний вираз',
                textTransformReplacementPlaceholder: 'Replacement',
                textTransformEmptyTitle: 'Шаблон має бути дійсним регулярним виразом (RegExp)',
            }
        },
        items: {
            searchProvider: {
            ...
            tagProps: {
                tagPropMode: {
                    name: 'Режим тегів (профіль сховища)',
                    desc: 'Режим тегів, який буде використовуватися для цього профілю сховища та відображатися в дереві тегів. «Немає» означає, що використовуються звичайні теги. «Замінити» означає, що видно лише власні властивості тегів, а звичайні теги приховано. «Об’єднати» означає, що видно як властивості тегів, так і звичайні теги.',
                    options: {
                        none: 'Жоден',
                        replace: 'Замінити',
                        merge: `Об'єднати`,
                ...
                mainTagProp: {
                    name: 'Головний тег (профіль сховища)',
                    desc: 'Дозволяє вказати, який тег або властивість тегу вважається "основним". Основні теги використовуються в операціях редагування тегів. "За замовчуванням" означає, що звичайні теги встановлені як основні. "Перша властивість тегу" означає, що перша властивість тегу у "списку властивостей тегу" встановлена ​​як "основна".',
                    options: {
                        default: 'За замовчуванням',
                        firstTagProp: 'Властивість першого тегу',
                    }
                },
                tagPropList: {
                    name: 'Властивості тегу (профіль сховища)',
                    desc: 'Список властивостей frontmatter, розділених комами. Перелічені властивості будуть розглядатися як додаткові джерела для тегів (наприклад, базові-теги, користувацькі-теги).',
                    placeholder: 'базові-теги, користувацькі-теги',
                },
            },
            ...
            collapseFileTagsToSelectedTag: {
                name: 'Згорнути теги до вибраного тегу',
                desc: 'Приховати батьківські сегменти, що є частиною вибраного перегляду тегів.'
            },
            colorFileTags: {
            ...
            titleTransformName: {
                name: 'Перетворення заголовків',
                desc: `Замінює весь заголовок або його частини на власне значення. Наприклад, ви можете використовувати це, щоб замінити "idea" на початку заголовка нотатки значком лампочки в Unicode. Використовує синтаксис "string.replace". Потрібне перебудування кешу для застосування змін до існуючих нотаток.`
            },
            previewTransformName: {
                name: 'Попередній перегляд трансформацій',
                desc: `Замінює весь попередній перегляд або його частини на власне значення. Може бути корисним, якщо ваші нотатки містять блоки, які ви не хочете бачити у списку нотаток. Використовує синтаксис "string.replace". Потрібне перебудування кешу для застосування змін до існуючих нотаток.`
            },
            showFeatureImage: {
            ...
            featureImageSize: {
                name: 'Розмір зображення',
                desc: 'Встановлює розмір зображення, яке буде використано у списку нотаток.'
            },
            featureImageForPDF: {
                name: 'Рекомендовані зображення для PDF-файлу',
                desc: 'Дозволяє створювати вибрані зображення для PDF-файлів.'
            },
            featureImagePersistIntermediate: {
                name: 'Зберегти повнофункціональне зображення на диск',
                desc: 'Тільки для досвідчених користувачів. Увімкнення цієї опції зберігає проміжні повнофункціональні зображення на диск. Може бути корисним для пришвидшення початкового індексування під час зміни розміру та синхронізації функціональних зображень. Потрібне перебудування кешу після ввімкнення. Не очищає проміжні зображення після вимкнення.'
            },
            showRootFolder: {
            ...
            rebuildCacheFast: {
                name: 'Оновити кеш',
                desc: `Використовуйте це, якщо у вас відсутні теги, неправильний попередній перегляд або відсутні зображення об’єктів. Це може статися після конфліктів синхронізації або неочікуваних закринь. Набагато легша версія, ніж «Перебудувати кеш», але може не вирішити всі проблеми.`,
                buttonText: 'Оновити кеш',
                success: 'Кеш оновлено',
